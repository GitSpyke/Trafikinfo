...
// load stations and departures
export async function GetNearbyStation(map, setStationCoordinates, setDepartures) {
...
export function CheckIfStationLocation(stationCoord, clickedCoord) {
    ...
    //if (Math.abs(stationCoord[0] - clickedCoord[0]) < 0.1) { return true; }
    return true;
}
